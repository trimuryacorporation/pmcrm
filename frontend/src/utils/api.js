...
export const endpoints = {
  ...
  accessUsers: () => api('/administrators/access-users'),
  updateAccessRole: (id, role) => api(`/administrators/access-users/${id}/role`, { method: 'PATCH', body: JSON.stringify({ role }) }),
  updateUserPermissions: (id, accessPermissions) => api(`/administrators/access-users/${id}/permissions`, { method: 'PATCH', body: JSON.stringify({ accessPermissions }) }),
